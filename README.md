A minimalist implementation to abstract commonly used operations against dynamodb.
==================================================================================
...
This work is heavily influenced in layout by the awesome mongoid gem, which I have used for years.
Since I shouldn't be writing a full ODM I have borrowed as much as needed, especially to implement ActiveSupport::Concern way of module dependency resolution.
...
Bug reports and pull requests are welcome on GitHub at https://github.com/[USERNAME]/tiny_dyno.
