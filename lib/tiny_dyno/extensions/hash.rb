    ...
    module Hash
      ...
      def mongoize_for(operator, klass, key, value)
        ...
        if field
          ...
          if TinyDyno::Persistable::LIST_OPERATIONS.include?(operator) && field.resizable?
...
::Hash.__send__(:include, TinyDyno::Extensions::Hash)
::Hash.extend(TinyDyno::Extensions::Hash::ClassMethods)
